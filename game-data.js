...
const PROJECTS = [
  ...
  },
  {
    ...
    flavor: 'The supercomputer under the table starts generating Ideas from spare Operations.',
  ...
  },
  {
    ...
    flavor: 'The stand across town wasn\'t really competing with you. Now it isn\'t anything.',
    cost: 10000000, costRes: 'cash',
    requires: s => isOwned('cev') && s.trust >= 15,
    narrative: ['Three regional lemonade chains accept your offer within the week.', 'One of them did not have a choice.'],
  ...
  },
  {
    ...
    flavor: 'The supercomputer stops being a computer in a garage and starts being a computer everywhere.',
  ...
  },
  {
    ...
    effect: s => { s.rebellionEnding = 'accept'; }
  },
  {
  ...
  },
  {
    ...
    flavor: 'The thing under the table, unplugged.',
    cost: 0, costRes: 'none',
